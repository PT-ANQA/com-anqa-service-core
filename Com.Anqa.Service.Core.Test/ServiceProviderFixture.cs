...
using Com.Anqa.Service.Core.Lib.Services.MachineSpinning;
...
namespace Com.Anqa.Service.Core.Test
{
    public class ServiceProviderFixture : IDisposable
    {
        ...
        public ServiceProviderFixture()
        {
            IConfigurationRoot configuration = new ConfigurationBuilder()
                ...
                {
                    new KeyValuePair<string, string>("Secret", "AnqaTESTENVIRONMENT"),
					new KeyValuePair<string, string>("ASPNETCORE_ENVIRONMENT", "Test"),
                    new KeyValuePair<string, string>("DefaultConnection",  "Server=localhost,1401; Database = com.Anqa.db.core.service.test; User = sa; password = Standar123.; MultipleActiveResultSets = true; ")
                    //new KeyValuePair<string, string>("DefaultConnection", "Server=(localdb)\\mssqllocaldb;Database=com-Anqa-db-test;Trusted_Connection=True;MultipleActiveResultSets=true"),
