...
using Com.Anqa.Service.Core.WebApi.Controllers.v1.BasicControllers;
...
namespace Com.Anqa.Service.Core.Test.Controllers.MasterExpedition
{
    public class BasicTests
    {
        ...
        public Com.Anqa.Service.Core.Lib.Models.MasterExpedition GetTestData(CoreDbContext dbContext)
        {
            Com.Anqa.Service.Core.Lib.Models.MasterExpedition data = new Com.Anqa.Service.Core.Lib.Models.MasterExpedition();
        ...
        public void Get_Return_OK()
        {
            ...
            Com.Anqa.Service.Core.Lib.Models.MasterExpedition testData = GetTestData(dbContext);
        ...
        public void POST_BadRequest()
        {
            ...
            validateServiceMock.Setup(v => v.Validate(It.IsAny<Com.Anqa.Service.Core.Lib.Models.MasterExpedition>())).Verifiable();
