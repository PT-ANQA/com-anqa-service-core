...
namespace Com.Anqa.Service.Core.WebApi
{
    public class Startup
    {
        ...
        private void RegisterEndPoint()
        {
            ...
            Com.Anqa.Service.Core.Lib.Helpers.APIEndpoint.StorageAccountName = Configuration.GetValue<string>("StorageAccountName") ?? Configuration["StorageAccountName"];
            Com.Anqa.Service.Core.Lib.Helpers.APIEndpoint.StorageAccountKey = Configuration.GetValue<string>("StorageAccountKey") ?? Configuration["StorageAccountKey"];
        }
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            //    {
            //        options.ApiName = "com.Anqa.service";
